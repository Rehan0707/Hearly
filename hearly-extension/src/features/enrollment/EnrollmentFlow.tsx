...
export function EnrollmentFlow({ onClose, onComplete }: EnrollmentFlowProps) {
  ...
  return (
    ...
    >
      ...
      <div className="popup-scroll relative flex min-h-0 flex-1 flex-col overflow-x-hidden overflow-y-auto px-6 pb-7 pr-5 [-webkit-overflow-scrolling:touch]">
        <div className="mx-auto flex w-full max-w-[312px] flex-none flex-col pb-2">
